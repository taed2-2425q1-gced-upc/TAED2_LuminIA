"""
This module evaluates a YOLO model for traffic sign detection.

It performs the following tasks:
1. Loads parameters and class names from a YAML file.
2. Creates a data dictionary for evaluation.
3. Evaluates the model and logs metrics using MLflow.
4. Saves evaluation metrics to a JSON file.
"""
...
data = {
    'train': (
        "/home/ramon/Desktop/GCED/TAED2_LuminIA/data/processed/"
        "train_images.txt"
